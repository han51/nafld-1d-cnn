...
result_dir = '../results/ff_estimator/'
test_file_list = '../data/file_lists_with_labels_ff_estimator/test.txt'
checkpoint_path = '../models/ff_estimator/'
result_filename = '../results/ff_estimator_without_tgc.mat'
...
for imgi in range(test_batches_per_epoch):
    ...
    y_label_images[imgi] = batch_test_y.mean()            
    y_raw_matrix[imgi,:] = sess.run(fc2, feed_dict={x: batch_test_x}).T
